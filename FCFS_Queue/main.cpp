...
void addTest1(FCFSQueue *q, Request *r, int t, int s);
std::tuple<int,int> getTest1(FCFSQueue *q, int t, int s);
...
FCFSQueue *createFCFSQueueFromRandomValues(int numRequestsToGenerate, int numTestsToRun) {
    // This function runs numTestsToRun (tests/times?) to test the FCFS queue. Each test consists of one
...
int main(int argc, char *argv[]) {
    ...
    Request *r2 = new Request(1, 1, 1);
    Request *r3 = new Request(2, 1, 1);
    ...
    auto * q = new FCFSQueue();
    addTest1(q, r1, 0, 0);
    pair = getTest1(q, std::get<0>(tup), std::get<1>(tup));
    addTest1(q, r2, std::get<0>(pair), std::get<1>(pair));
    addTest1(q, r3, std::get<0>(pair), std::get<1>(pair));
    pair = getTest1(q, std::get<0>(pair), std::get<1>(pair));
    pair = getTest1(q, std::get<0>(pair), std::get<1>(pair));
    addTest1(q, r4, std::get<0>(pair), std::get<1>(pair));
    addTest1(q, r5, std::get<0>(pair), std::get<1>(pair));
    addTest1(q, r6, std::get<0>(pair), std::get<1>(pair));
    pair = getTest1(q, std::get<0>(pair), std::get<1>(pair));
    addTest1(q, r7, std::get<0>(pair), std::get<1>(pair));
    pair = getTest1(q, std::get<0>(pair), std::get<1>(pair));
    pair = getTest1(q, std::get<0>(pair), std::get<1>(pair));
